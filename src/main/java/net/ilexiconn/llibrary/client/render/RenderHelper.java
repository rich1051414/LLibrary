...
public class RenderHelper
{
    ...
    // private static ResourceLocation glintTexture = new
    ...
    // ItemRenderer.renderItemIn2D(tessellator, 0f, 0f, 1f, 1f, 256, 256,
    // 0625f);
    // GL11.glPopMatrix();
    // GL11.glPushMatrix();
    // GL11.glScalef(f8, f8, f8);
    ...
    // public static void registerItem3dRenderer(Item item, ModelBase model,
    // ResourceLocation texture)
    // {
    // MinecraftForgeClient.registerItemRenderer(item, new Item3dRenderer(item,
    // model, texture));
    // }
}
